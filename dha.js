...
petik = '```'
fake = 'CREATOR BOT\©RennXd'//GANTI NAMA KAMU BEP
ban =[]
...
dha.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
        ...
        case 'menu':
        case 'help':
        menu =`Hai Kak.....\n*${pushname}*\n\`\`\`Saya RENNXD BOTZ,SENANG BISA BERTEMU DENGANMU HARI INI\`\`\`
...
©𝑪𝒓𝒆𝒂𝒕𝒐𝒓 ©rennXd`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '\`\`\`RennXd-Botz  - Ketik .allmenu Untuk Menampilkan Semua Menu\`\`\`', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
...
//------------------< Premium >-------------------
       ...
       case 'buypremium':
       case 'sewabot':
              gopeynya = 'https://telegra.ph/file/7a1cba3da039bf0aefb4d.jpg'
              teksnya = `*── 「 PRICE LIST 」 ──*
...
//------------------< Lainnya >-------------------
        ...
        case 'info':  // Jangan Di Ubah Plise
               urlinfo = 'https://telegra.ph/file/7a1cba3da039bf0aefb4d.jpg'
